			...
			<nav class="navbar navbar-inverse navbar-static-top">
				<div class="container">
					<div class="navbar-header">
						...
						<a class="navbar-brand" href="../main/main.jsp">스벅 카피</a>
					</div>
			...
			<div style="padding-top: 50px;">
				<main>
					...
					<div class="find-wrap">
						...
						<form action="change_pw.do" method="post" name="change_pw">


							<input class="form-change-pw" type="password" name="member_pw"
								placeholder="비밀번호입력" required> <input
								class="form-change-pw" type="password" name="re_member_pw"
								placeholder="비밀번호확인" required> <br> <br>
							<!--변경버튼-->
							<input class="click-btn" type="button" value="변경"
								onclick="modify()"> <br> <br> <br> <br>
							<br> <br>
						</form>
					</div>
				</main>
