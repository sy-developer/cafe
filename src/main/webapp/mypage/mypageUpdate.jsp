			...
			<main>
				<aside class="sidebar_a">
					<ul>
						...
						<li><a href="../market/market.do"> 장바구니 </a></li>
						<li><a href="">위시리스트</a></li>
						<li><a href=""> 구매내역 </a></li>
						<li><a href="../mypage/drop_id.do">회원탈퇴</a></li>
					</ul>
				</aside>
				<section>
					<article class="container_a">

						<form action="../mypage/mypageModify.do" method="post" class="aaa">
							<div class="editdiv">
								...
								<table class="edittable">
									...
									<tr>
										<th>생년월일</th>
										<td>${dto.age} <input type="hidden" name="member_birth"
											value="${dto.age}">
										</td>
									</tr>
									<tr>
										...
										<td><input name="member_phone" type="text"
											placeholder="핸드폰번호( - 제외입력)" value="${dto.tel}"></td>
									</tr>
									<tr>
										<th>이메일</th>
										<td><input name="member_email" type="email"
											placeholder="이메일" value="${dto.email}"></td>
									</tr>
									<tr>
										<th>우편번호</th>
										<td><input name="member_post" type="text"
											placeholder="우편번호" value="${dto.addr1}"></td>
									</tr>
									<tr>
										<th>주소</th>
										<td><input name="member_base_addr" type="text"
											placeholder="주소입력" value="${dto.addr2}"></td>
									</tr>
									<tr>
										<th>상세주소</th>
										<td><input name="member_extra_addr" type="text"
											placeholder="상세주소입력" value="${dto.addr3}"></td>
									</tr>
