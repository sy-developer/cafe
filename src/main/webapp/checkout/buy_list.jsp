			...
			<nav class="navbar navbar-inverse navbar-static-top">
				<div class="container">
					...
					<div id="navbar" class="navbar-collapse collapse">
						...
						<div>
							<h1 style="text-align: center; margin: 100px 20px 10px 10px;">결제한 상품목록</h1>
						</div>
						<br />
	<div id="frame" class="aaa">
								...
								<thead>
									...
									<tr>
										<th><input style="width: 10px;" type="checkbox"  id="check" class="cart_all_click"
											onchange="javascript:basket.selectAll();"></th>
								...
								<tbody>			
									...
									<tr style="height: 90px; background-color: #fff;">
										<td colspan="7">
												...
												<div class="row data">
													<tr style="height: 90px; background-color: #fff;">
														<td style="text-align: left; text-align: center; border-right: none; width: 3%">
															<input type="checkbox" name="cart_no" id ="p_no" class="checked"  value=${dto.stock_num } onclick="javascript:basket.checkItem();">
														</td>
														<td style="border-left: none; border-right: none;" id="p_name">${dto.menu_name }<br>
														
															<a href="#">
															<img src="../storage/${dto.image }" width="100px" height="100px"> <!--dto에 image값이 없음  -->
															</a>
														
														</td>
														<td style="text-align: left; padding-left: 10px; border-left: none; font-weight: bold;">${dto.info }</td>
				
														<td><span style="padding-left: 10px;" id="p_price" value=${dto.price }>${dto.price }</span>원</td>
														
														<td style="width: 50px;">
														
															<!-- 이 배치가 바뀌면 프로그래밍에 문제가 생김(강사 왈) -->
															<input type="number" style="text-align: right; width: 40px; margin-bottom: 3px;" name="cart_cnt" calss="p_num" min="1" max="99" step="1" value="${dto.amount }">
															<input type="button" class="btn default" style="border-radius: 3px; size: 10px;" value="변경" onclick="sendEdit(this);">
															<input type="hidden" value=${dto.stock_num }>
								...
								<tfoot>
									<tr style="height: 60px;">
										...
										<td colspan="5"
											...
											<!-- 전체 핪 데이터 데이터 처리 문구 필요 -->
											상품금액 : <span id="sum_p_price" >0</span>원 + <span id="deliver">${fee }</span><span>원  = </span><span id="finalPrice">0+${fee }원</span>&nbsp;<span
						...
						<table class="calculation2">
							<tr>
								...
								<th style="width: 750px; padding: 22px 0;"><span>최종결제금액</span></th>
							</tr>

							<tr style="background-color: #fff;">
								<td style="padding: 22px 0;" ><span class="price" id="sum_p_price2">0</span>원</td>
								<td><span class="price" id="deliver2">0</span>원
								</td>
								<td><span class="price" id="finalPrice2">0</span>원
								</td>
	...
	<div id="frame" class="bbb">
						...
						<div
							...
							<ol>
								...
								<br>
								<li class="lifont">상품을 개봉, 설치한 후에는 상품의 재판매가 불가능하므로 고객님의
