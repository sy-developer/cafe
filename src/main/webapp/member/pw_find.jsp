				...
				<main>
					...
					<div class="find-wrap">
						...
						<form action="find_pw.do" method="post">
							...
							<input class="form-change-pw" type="text" name="member_id"
								placeholder="회원아이디확인" required> 
							<input class="form-change-pw" type="text" name="member_name"
								placeholder="회원이름확인" required>
							<input class="form-change-pw" type="text" name="member_tel"
								placeholder="회원전화번호확인" required> 
							<!--변경버튼-->
