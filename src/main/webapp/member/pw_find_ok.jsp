		...
		<main>
			...
			<div class="find-wrap">
				...
				<div class="center">
					...
					<br>
					<c:if test="${search_pw != null}">
						<h3>
							소중한 ${name}님의 비밀번호는
							<P></P>
							<span>${search_pw }</span>입니다
						</h3>
					</c:if>
					<c:if test="${search_pw == null}">
						<h3>입력하신 정보로 해당 PW를 찾을수 없습니다.</h3>
					</c:if>
					<br>
					...
					<div class="change_after">
						...
						<a href="../member/id_find.jsp"> <input class="click-btn2"
							type="submit" value="아이디찾기"></a>
					</div>
