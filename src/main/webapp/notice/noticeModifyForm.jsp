...
<body>
	...
	<header id="notice_modify_header">
		<h1>공지사항 수정하기</h1>
	</header>
				...
				<table>
					<tr>
						<th>제목</th>
						<td><input type="text" name="subject" size="43" value="">${notice_subject}</td>
					</tr>
					<tr>
						<th>내용</th>
						<td><textarea rows="15" cols="45" name="content">${notice_content }</textarea></td>
					</tr>
					<tr>
